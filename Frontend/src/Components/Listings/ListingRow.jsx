        ...
        <div className="option">
          <span
            className={`leftArrow navArrow ${
              blurLeft ? "cursor-pointer bg-[#e8e8e8] opacity-100 hover:bg-[#d5d5d5] " : "cursor-not-allowed opacity-20 "
            }`}
            onClick={scrollLeft}
          >
          ...
          <span
            className={`rightArrow navArrow ${
              blurRight ? "cursor-pointer bg-[#e8e8e8] hover:bg-[#d5d5d5] " : "cursor-not-allowed opacity-20"
            }`}
            onClick={scrollRight} 
          >
